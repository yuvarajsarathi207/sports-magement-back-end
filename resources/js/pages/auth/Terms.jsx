...
export default function Terms() {
    return (
        <div className="page terms-page">
            <Link to="/register" className="back-btn">← Back to Register</Link>
            ...
            <h1 className="terms-title" id="privacy">Privacy Policy</h1>

            <section className="terms-section">
                <h2>Introduction</h2>
                <p>
                    This Privacy Policy describes how 9952914715 and its affiliates (collectively &quot;9952914715, we, our, us&quot;)
                    collect, use, share, protect or otherwise process your information/ personal data through our website
                    https://keepplaying.in/ (hereinafter referred to as Platform). Please note that you may be able to browse
            ...
            <section className="terms-section">
                ...
                <p>
                    ...
                    any information. If you receive an email, a call from a person/association claiming to be 9952914715
            ...
            <h1 className="terms-title" id="shipping">Shipping Policy</h1>
